			...
			<div class="admin_modify_style" id="Personal">
				...
				<div class="xinxi">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="用户名" id="website-title1"
								value="${admin.aname}" class="col-xs-7 text_info"
								disabled="disabled" /> &nbsp;&nbsp;&nbsp;<a
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="年龄" id="website-title3"
								value="20" class="col-xs-7 text_info"
								disabled="disabled" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="移动电话" id="website-title4"
								value="1325452154" class="col-xs-7 text_info"
								disabled="disabled" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="电子邮箱" id="website-title5"
								value="1651251321@qq.com" class="col-xs-7 text_info"
								disabled="disabled" />
						</div>
					</div>
	...
	<div class="change_Pass_style" id="change_Pass">
		<ul class="xg_style">
			<li><label class="label_name">原&nbsp;&nbsp;密&nbsp;码</label><input
				name="原密码" type="password" class="" value="${admin.pwd }"
				id="password" /></li>
