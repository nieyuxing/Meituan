			...
			<div id="body-content-on-content">
				<div id="details-up">
					...
					<div class="details-up-right">
						...
						<div class="box04">
							<input class="qianggou" type="submit" value="√ 立即抢购"> <a
								href="" id="che"><img src="../images/gouwuche.jpg"></a>
						</div>
					</div>
				</div>
				<div id="details-down">
							...
							<div id="left-box02-down">
								<ul>
									...
									<li class="left-box02-down-li">
										<div class="li-left">
											<img src="../images/ip01.jpg" alt="头像" width="50" height="50">
											<p>ssss</p>
										</div>
										<div class="li-right">
									...
									<li class="left-box02-down-li">
										<div class="li-left">
											<img src="../images/ip01.jpg" alt="头像">
											<p>ssss</p>
										</div>
										<div class="li-right">
											<div class="li-right-up">
