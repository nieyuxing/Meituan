...
<div id="body-content">
	<div id="body-content-on">
    	<div id="on-one">
        	<img src="../images/shopping01.jpg" alt="shopping" />
            <span>我的购物车</span>
            1/20
        </div>
        <div id="on-two">
            <table id="shopping" cellspacing="0">
                <tbody>
                    <tr class="list-up">
                        <th width="60">
                        <input id="cart-selectall" class="ui-checkbox" type="checkbox" mb-onchange="" mb-checked="isAllChecked">
                        <label class="cart-select-all" for="cart-selectall">全选</label>
                        </th>
                    ...
                    <tr class="jiezhang">
                    	<td></td>
                        <td></td>
                        <td class="jiezhan-money" colspan="4">
                        	已选<span style="color:#F00">1</span>件商品&nbsp;&nbsp;<span style="font-weight:bold">应付金额：</span><span style="color:#F00;font-size:24px">￥12.99</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div id="on-three">
            	<h3>收货地址<span><a>管理</a></span></h3>
                <div id="dizhi">
                	<div class="dizhi-box">
                    	<span style="color:#F00;">*</span>所在地区：
                        <select id="address-province" class="address-province" autocomplete="off" name="adrProvince">
                        ...
                        <select id="address-city" class="address-city" autocomplete="off" name="adrCity">
							<option value="-1">--城市--</option>
						</select>
                        <select id="address-district" class="address-district" autocomplete="off" name="adrDistrict">
                            <option value="-1">--市区--</option>
                        </select>
                    </div>
                    
                    <div class="dizhi-box">
                    	<span style="color:#F00;">*</span>街道地址：<input id="address-detail" class="address-detail" type="text" value="" name="adrAddress" size="60" maxlength="60"><span class="error"></span>
                    </div>
                    <div class="dizhi-box">
                    	<span style="color:#F00;">*</span>邮政编码：<input id="address-zipcode" class="address-zipcode" type="text" value="" name="adrZipCode" size="10" maxlength="20"><span class="error"></span>
                    </div>
                    <div class="dizhi-box">
                    	<span style="color:#F00;">*</span>收货人姓名：<input id="address-name" class="address-name" type="text" value="" name="adrName" size="15" maxlength="15"><span class="error"></span>
                    </div>
                    <div class="dizhi-box">
                    	<span style="color:#F00;">*</span>电话号码：<input id="address-phone" class="address-phone" type="text" value="" name="adrPhone" size="15" maxlength="20"><span class="error"></span>
                    </div>
                    <hr>
                    <h4>希望送货的时间</h4>
                    <ul>
                    	<li id="">
							<input id="" class="ui-radio" type="radio" name="deliveryType" value="16">
							<label id="">只工作日送货(双休日、假日不用送，写字楼/商用地址客户请选择)</label>
						</li>
                        <li id="">
                        	<input id="" class="ui-radio" type="radio" name="deliveryType" value="32">
                        	<label id="">只双休日、假日送货(工作日不用送)</label>
                        </li>
                        <li id="">
                        	<input id="" class="ui-radio" type="radio" name="deliveryType" value="64">
                        	<label id="">学校地址/地址白天没人，请尽量安排其它时间送货 (特别安排可能会超出预计送货天数)</label>
                        </li>
                         <li id="">
                        	<input id="" class="ui-radio" type="radio" name="deliveryType" value="64">
                        	<label id="">工作日、双休日与假期均可送货</label>
                        </li>
                    </ul>
                    <hr>
                    <h4>配送说明<span style="font-size:12px;color:#999">（快递公司由商家根据情况选择，请不要指定。其他要求会尽量协调）</span></h4>
                    <input id="" class="comment" type="text" value="" name="deliveryComment">
                </div>
        </div>
        <div id="on-four">
            	<h3>您的手机</h3>
                ...
                <div class="on-four-on-one">
                	手机号<input id="" class="small" type="text" value="" name="mobile" maxlength="11" autocomplete="off">
                    <span class="error"></span>
                </div>
                <input id="" class="btn-mini" type="button" value="获取手机动态码">
                <div class="on-four-on-one">
                	动态码<input id="" class="small" type="text" value="" name="verifycode" autocomplete="off">
                   	<span class="error"></span>
                </div>
        </div>
        <div id="on-five">
        	<input class="btn-buy" type="submit" onclick="" value="提交订单" name="buy" gaevent="cart/orderconfirm">
        </div>
    </div>
</div>
<div id="body-footer">
